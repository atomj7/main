...
public class Contract implements Serializable {
    ...
    public void setIds(Set<Subcontract> subcontracts) {
        if (this.ids != null) {
            this.ids.forEach(i -> i.setContractId(null));
        }
        if (subcontracts != null) {
            subcontracts.forEach(i -> i.setContractId(this));
        }
        this.ids = subcontracts;
    }

    public Contract ids(Set<Subcontract> subcontracts) {
        this.setIds(subcontracts);
        return this;
    }

    public Contract addId(Subcontract subcontract) {
        this.ids.add(subcontract);
        subcontract.setContractId(this);
        return this;
    }

    public Contract removeId(Subcontract subcontract) {
